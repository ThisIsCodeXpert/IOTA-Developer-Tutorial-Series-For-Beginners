...
import { bytesSum, switchDecoder, uint8Decoder, progressDecoder, getRoundedIeee754ToBase10 } from '../helpers';
...
var DiagnosticsResponse = function (_PropertyResponse) {
   ...
   */
  function DiagnosticsResponse(data) {
    ...
    var properties = [new Property(0x01, 'mileage').setDecoder(bytesSum), new Property(0x02, 'engineOilTemperature').setDecoder(bytesSum), new Property(0x03, 'speed').setDecoder(bytesSum), new Property(0x04, 'engineRPM').setDecoder(bytesSum), new Property(0x05, 'fuelLevel').setDecoder(progressDecoder), new Property(0x06, 'estimatedRange').setDecoder(bytesSum), new Property(0x09, 'washerFluidLevel').setDecoder(switchDecoder({
      0x00: 'low',
      0x01: 'filled'
    })), new Property(0x0b, 'batteryVoltage').setDecoder(getRoundedIeee754ToBase10(2)), new Property(0x0c, 'adblueLevel').setDecoder(getRoundedIeee754ToBase10(2)), new Property(0x0d, 'distanceSinceReset').setDecoder(bytesSum), new Property(0x0e, 'distanceSinceStart').setDecoder(bytesSum), new Property(0x0f, 'fuelVolume').setDecoder(getRoundedIeee754ToBase10(2)), new Property(0x10, 'antiLockBraking').setDecoder(switchDecoder({
      0x00: 'inactive',
      0x01: 'active'
    })), new Property(0x11, 'engineCoolantTemperature').setDecoder(uint8Decoder), new Property(0x12, 'engineTotalOperatingHours').setDecoder(getRoundedIeee754ToBase10(2)), new Property(0x13, 'engineTotalFuelConsumption').setDecoder(getRoundedIeee754ToBase10(2)), new Property(0x14, 'brakeFluidLevel').setDecoder(switchDecoder({
      0x00: 'low',
      0x01: 'filled'
    })), new Property(0x15, 'engineTorque').setDecoder(progressDecoder), new Property(0x16, 'engineLoad').setDecoder(progressDecoder), new Property(0x17, 'wheelBasedSpeed').setDecoder(bytesSum), new Property(0x18, 'batteryLevel').setDecoder(progressDecoder), new Property(0x19, 'checkControlMessages').setDecoder(_this.checkControlMessagesDecoder), new Property(0x1a, 'tirePressures').setOptionalSubProperties('location', [new OptionalProperty(0x00, 'front_left').setDecoder(_this.pressureDecoder), new OptionalProperty(0x01, 'front_right').setDecoder(_this.pressureDecoder), new OptionalProperty(0x02, 'rear_right').setDecoder(_this.pressureDecoder), new OptionalProperty(0x03, 'rear_left').setDecoder(_this.pressureDecoder)]), new Property(0x1b, 'tireTemperatures').setOptionalSubProperties('location', [new OptionalProperty(0x00, 'front_left').setDecoder(_this.temperatureDecoder), new OptionalProperty(0x01, 'front_right').setDecoder(_this.temperatureDecoder), new OptionalProperty(0x02, 'rear_right').setDecoder(_this.temperatureDecoder), new OptionalProperty(0x03, 'rear_left').setDecoder(_this.temperatureDecoder)]), new Property(0x1c, 'wheelRpms').setOptionalSubProperties('location', [new OptionalProperty(0x00, 'front_left').setDecoder(_this.rpmDecoder), new OptionalProperty(0x01, 'front_right').setDecoder(_this.rpmDecoder), new OptionalProperty(0x02, 'rear_right').setDecoder(_this.rpmDecoder), new OptionalProperty(0x03, 'rear_left').setDecoder(_this.rpmDecoder)]), new Property(0x1d, 'troubleCodes').setDecoder(_this.troubleCodesDecoder), new Property(0x1e, 'mileageMeters').setDecoder(bytesSum)];
  ...
  _createClass(DiagnosticsResponse, [{
    ...
    value: function checkControlMessagesDecoder(bytes) {
      var textLength = bytesSum(bytes.slice(6, 8));
      var text = bytesToString(bytes.slice(8, 8 + textLength));
      var statusLength = bytes[9 + textLength];
      var status = bytesToString(bytes.slice(9 + textLength, 10 + textLength + statusLength));
    ...
    value: function troubleCodesDecoder(bytes) {
      ...
      return [{
        ...
        ecuId: bytesToString(bytes.slice(3 + idLength, 3 + idLength + ecuIdLength)),
        status: bytesToString(bytes.slice(4 + idLength + ecuIdLength, 4 + idLength + ecuIdLength + statusLength))
      }];
    }
  }]);
