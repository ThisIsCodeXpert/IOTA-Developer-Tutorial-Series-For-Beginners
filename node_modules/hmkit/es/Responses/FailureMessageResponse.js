...
var FailureMessageResponse = function (_PropertyResponse) {
  ...
  function FailureMessageResponse(data, config) {
    ...
    var properties = [new PropertyDecoder(0x01, 'autoApi').setDecoder(_this.failedCapabilityDecoder), new PropertyDecoder(0x02, 'type'), new PropertyDecoder(0x03, 'reason').setDecoder(_this.reasonDecoder)];
