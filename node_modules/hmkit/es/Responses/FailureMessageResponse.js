...
var FailureMessageResponse = function (_PropertyResponse) {
   ...
   */
  function FailureMessageResponse(data) {
    ...
    var properties = [new Property(0x01, 'autoApi').setDecoder(_this.failedCapabilityDecoder), new Property(0x02, 'type'), new Property(0x03, 'reason').setDecoder(_this.reasonDecoder)];
  ...
  _createClass(FailureMessageResponse, [{
    ...
    value: function failedCapabilityDecoder(bytes) {
      var autoApi = Object.values(autoApis).find(function (api) {
...
export default FailureMessageResponse;