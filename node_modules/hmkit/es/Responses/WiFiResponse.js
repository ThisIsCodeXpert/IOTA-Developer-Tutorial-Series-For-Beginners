...
var WiFiResponse = function (_PropertyResponse) {
  ...
  function WiFiResponse(data) {
    ...
    var properties = [new Property(0x01, 'wifiEnabled').setDecoder(switchDecoder({
      0x00: 'disabled',
      0x01: 'enabled'
    })), new Property(0x02, 'networkConnected').setDecoder(switchDecoder({
      0x00: 'disconnected',
      0x01: 'connected'
    })), new Property(0x03, 'networkSSID').setDecoder(bytesToString), new Property(0x04, 'networkSecurity').setDecoder(switchDecoder({
      0x00: 'none',
      0x01: 'wep',
      0x02: 'wpa',
      0x03: 'wpa2_personal'
