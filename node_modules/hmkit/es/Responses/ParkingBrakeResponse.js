...
var ParkingBrakeResponse = function (_PropertyResponse) {
   ...
   */
  function ParkingBrakeResponse(data, config) {
    ...
    var properties = [new PropertyDecoder(0x01, 'parkingBrake').setDecoder(activeInactiveDecoder())];
...
export default ParkingBrakeResponse;