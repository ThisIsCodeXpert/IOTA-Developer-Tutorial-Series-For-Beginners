...
var TachographResponse = function (_PropertyResponse) {
  ...
  */
  function TachographResponse(data, config) {
    ...
    var properties = [new PropertyDecoder(0x01, 'driverWorkingStates').setOptionalSubProperties('driverNumber', [new OptionalPropertyDecoder(0x01, 1).setDecoder(_this.driverWorkingStateDecoder), new OptionalPropertyDecoder(0x02, 2).setDecoder(_this.driverWorkingStateDecoder)]), new PropertyDecoder(0x02, 'driverTimeStates').setOptionalSubProperties('driverNumber', [new OptionalPropertyDecoder(0x01, 1).setDecoder(_this.driverTimeStateDecoder), new OptionalPropertyDecoder(0x02, 2).setDecoder(_this.driverTimeStateDecoder)]), new PropertyDecoder(0x03, 'driverCards').setOptionalSubProperties('driverNumber', [new OptionalPropertyDecoder(0x01, 1).setDecoder(_this.driverCardDecoder), new OptionalPropertyDecoder(0x02, 2).setDecoder(_this.driverCardDecoder)]), new PropertyDecoder(0x04, 'vehicleMotion').setDecoder(switchDecoder({
      0x00: 'not_detected',
      0x01: 'detected'
    })), new PropertyDecoder(0x05, 'vehicleOverspeed').setDecoder(switchDecoder({
      0x00: 'no_overspeed',
      0x01: 'overspeed'
    })), new PropertyDecoder(0x06, 'vehicleDirection').setDecoder(switchDecoder({
      0x00: 'forward',
      0x01: 'reverse'
