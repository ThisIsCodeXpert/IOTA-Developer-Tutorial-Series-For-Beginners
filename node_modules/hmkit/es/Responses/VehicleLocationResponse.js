...
var VehicleLocationResponse = function (_PropertyResponse) {
  ...
  function VehicleLocationResponse(data) {
    ...
    var properties = [new Property(0x04, 'coordinates').setDecoder(coordinatesDecoder), new Property(0x05, 'heading').setDecoder(function (bytes) {
      return getRoundedIeee754DoubleToBase10(6)(bytes, 8);
    }), new Property(0x06, 'altitude').setDecoder(function (bytes) {
      return getRoundedIeee754DoubleToBase10(6)(bytes, 8);
    })];
