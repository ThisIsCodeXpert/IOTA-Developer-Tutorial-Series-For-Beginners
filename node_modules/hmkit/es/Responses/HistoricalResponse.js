...
var HistoricalResponse = function (_PropertyResponse) {
  ...
  function HistoricalResponse(data) {
    ...
    var properties = [new CapabilityProperty(0x01, 'states').setOptionalSubProperties('capabilityIdentifier', Object.entries(CAPABILITY_IDENTIFIERS).map(function (_ref) {
