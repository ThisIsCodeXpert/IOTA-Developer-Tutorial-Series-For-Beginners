...
var WindowsResponse = function (_PropertyResponse) {
  ...
  function WindowsResponse(data) {
    ...
    var properties = [new Property(0x02, 'windowsOpenPercentages').setOptionalSubProperties('windowLocation', [new OptionalProperty(0x00, 'front_left').setDecoder(_this.openPercentageDecoder), new OptionalProperty(0x01, 'front_right').setDecoder(_this.openPercentageDecoder), new OptionalProperty(0x02, 'rear_right').setDecoder(_this.openPercentageDecoder), new OptionalProperty(0x03, 'rear_left').setDecoder(_this.openPercentageDecoder), new OptionalProperty(0x04, 'hatch').setDecoder(_this.openPercentageDecoder)]), new Property(0x03, 'windowsPositions').setOptionalSubProperties('windowLocation', [new OptionalProperty(0x00, 'front_left').setDecoder(_this.positionDecoder), new OptionalProperty(0x01, 'front_right').setDecoder(_this.positionDecoder), new OptionalProperty(0x02, 'rear_right').setDecoder(_this.positionDecoder), new OptionalProperty(0x03, 'rear_left').setDecoder(_this.positionDecoder), new OptionalProperty(0x04, 'hatch').setDecoder(_this.positionDecoder)])];
...
export default WindowsResponse;