...
var OffroadResponse = function (_PropertyResponse) {
   ...
   */
  function OffroadResponse(data, config) {
    ...
    var properties = [new PropertyDecoder(0x01, 'routeIncline').setDecoder(_this.routeInclineDecoder), new PropertyDecoder(0x02, 'wheelSuspension').setDecoder(progressDecoder)];
