...
var PowerTakeOffResponse = function (_PropertyResponse) {
  ...
  function PowerTakeOffResponse(data) {
    ...
    var properties = [new Property(0x01, 'powerTakeoff').setDecoder(switchDecoder({
      0x00: 'inactive',
      0x01: 'active'
    })), new Property(0x02, 'powerTakeoffEngaged').setDecoder(switchDecoder({
      0x00: 'not_engaged',
      0x01: 'engaged'
    }))];
...
export default PowerTakeOffResponse;