...
var CapabilitiesResponse = function (_PropertyResponse) {
  ...
  function CapabilitiesResponse(data) {
    ...
    var properties = [new CapabilityProperty(0x01, 'capabilities').setOptionalSubProperties('capabilityIdentifier', Object.entries(CAPABILITY_IDENTIFIERS).map(function (_ref) {
      var _ref2 = _slicedToArray(_ref, 2),
          name = _ref2[0],
          identifier = _ref2[1].identifier;

      return new OptionalProperty(identifier, name).setDecoder(_this.getCapabilityDecoder(name));
    }))];
