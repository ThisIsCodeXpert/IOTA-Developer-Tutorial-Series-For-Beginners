...
var FirmwareVersionResponse = function (_PropertyResponse) {
  ...
  function FirmwareVersionResponse(data) {
    ...
    var properties = [new Property(0x01, 'carSDKVersion').setDecoder(_this.carSDKVersionDecoder), new Property(0x02, 'carSDKBuildName').setDecoder(bytesToString), new Property(0x03, 'applicationVersion').setDecoder(bytesToString)];
...
export default FirmwareVersionResponse;