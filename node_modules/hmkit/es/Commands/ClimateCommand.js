...
var ClimateCommand = function (_BaseCommand) {
  ...
  _createClass(ClimateCommand, null, [{
    ...
    value: function setWeekdayStartingTimes(weekdayStartingTimes) {
      ...
      return new Command([0x00, 0x24, 0x12].concat(_toConsumableArray(weekdayStartingTimesBytes)));
    }
    ...
    value: function startHvac() {
      return new Command([0x00, 0x24, 0x13].concat(_toConsumableArray(this.buildProperty(0x01, 0x01))));
    }
    ...
    value: function stopHvac() {
      return new Command([0x00, 0x24, 0x13].concat(_toConsumableArray(this.buildProperty(0x01, 0x00))));
    }
    ...
    value: function startDefogging() {
      return new Command([0x00, 0x24, 0x14].concat(_toConsumableArray(this.buildProperty(0x01, 0x01))));
    }
    ...
    value: function stopDefogging() {
      return new Command([0x00, 0x24, 0x14].concat(_toConsumableArray(this.buildProperty(0x01, 0x00))));
    }
    ...
    value: function startDefrosting() {
      return new Command([0x00, 0x24, 0x15].concat(_toConsumableArray(this.buildProperty(0x01, 0x01))));
    }
    ...
    value: function stopDefrosting() {
      return new Command([0x00, 0x24, 0x15].concat(_toConsumableArray(this.buildProperty(0x01, 0x00))));
    }
    ...
    value: function startIonising() {
      return new Command([0x00, 0x24, 0x16].concat(_toConsumableArray(this.buildProperty(0x01, 0x01))));
    }
    ...
    value: function stopIonising() {
      return new Command([0x00, 0x24, 0x16].concat(_toConsumableArray(this.buildProperty(0x01, 0x00))));
    }
    ...
    value: function setTemperatureSettings(driverTemperatureSetting, passengerTemperatureSetting, rearTemperatureSetting) {
      ...
      return new Command([0x00, 0x24, 0x17].concat(_toConsumableArray(this.buildProperty(0x01, base10ToIeee754(driverTemperatureSetting))), _toConsumableArray(this.buildProperty(0x02, base10ToIeee754(passengerTemperatureSetting))), _toConsumableArray(this.buildProperty(0x03, base10ToIeee754(rearTemperatureSetting)))));
    }
  }, {
    key: 'getWeekdayByte',
