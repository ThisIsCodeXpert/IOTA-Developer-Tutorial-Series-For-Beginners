...
var CruiseControlCommand = function (_BaseCommand) {
  ...
  _createClass(CruiseControlCommand, null, [{
    ...
    value: function activateCruiseControl(targetSpeed) {
      ...
      return new Command([0x00, 0x62, 0x12].concat(_toConsumableArray(this.buildProperty(0x01, 0x01)), _toConsumableArray(targetSpeedBytes)));
    }
    ...
    value: function deactivateCruiseControl() {
      return new Command([0x00, 0x62, 0x12].concat(_toConsumableArray(this.buildProperty(0x01, 0x00))));
    }
  }]);
...
export default CruiseControlCommand;