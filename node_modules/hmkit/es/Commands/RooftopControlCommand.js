...
var RooftopControlCommand = function (_BaseCommand) {
  ...
  _createClass(RooftopControlCommand, null, [{
    ...
    value: function control(dimming, position, convertibleRoof, sunroofTilt, sunroofState) {
      var dimmingBytes = typeof dimming !== 'number' ? [] : [0x01, 0x00, 0x01, percentToInteger(dimming)];

      var positionBytes = typeof position !== 'number' ? [] : [0x02, 0x00, 0x01, percentToInteger(position)];
      ...
      return new Command([0x00, 0x25, 0x12].concat(dimmingBytes, positionBytes, _toConsumableArray(convertibleRoofBytes), _toConsumableArray(sunroofTiltBytes), _toConsumableArray(sunroofStateBytes)));
    }
  }]);
