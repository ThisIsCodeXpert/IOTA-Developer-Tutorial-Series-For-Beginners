...
var HomeChargerCommand = function (_BaseCommand) {
  ...
  _createClass(HomeChargerCommand, null, [{
    ...
    value: function setChargeCurrent(current) {
      ...
      return new Command([0x00, 0x60, 0x12].concat(_toConsumableArray(this.buildProperty(0x01, base10ToIeee754(current)))));
    }
    ...
    value: function setPriceTariffs(priceTariffs) {
      return new Command([0x00, 0x60, 0x13].concat(_toConsumableArray(this.getPriceTariffsBytes(priceTariffs))));
    }
    ...
    value: function activateSolarCharging() {
      return new Command([0x00, 0x60, 0x14].concat(_toConsumableArray(this.buildProperty(0x01, 0x01))));
    }
    ...
    value: function deactivateSolarCharging() {
      return new Command([0x00, 0x60, 0x14].concat(_toConsumableArray(this.buildProperty(0x01, 0x00))));
    }
    ...
    value: function enableWifiHotspot() {
      return new Command([0x00, 0x60, 0x15].concat(_toConsumableArray(this.buildProperty(0x01, 0x01))));
    }
    ...
    value: function disableWifiHotspot() {
      return new Command([0x00, 0x60, 0x15].concat(_toConsumableArray(this.buildProperty(0x01, 0x00))));
    }
    ...
    value: function authenticate() {
      return new Command([0x00, 0x60, 0x16].concat(_toConsumableArray(this.buildProperty(0x01, 0x01))));
    }
    ...
    value: function expireAuthentication() {
      return new Command([0x00, 0x60, 0x16].concat(_toConsumableArray(this.buildProperty(0x01, 0x00))));
    }
  }, {
    ...
    value: function getPriceTariffsBytes(priceTariffs) {
      ...
      return priceTariffs.reduce(function (priceTariffsBytes, _ref) {
        ...
        if (currentPricingType !== undefined) {
          return priceTariffsBytes.concat(_this2.buildProperty(0x0c, [currentPricingType].concat(_toConsumableArray(base10ToIeee754(price)), _toConsumableArray(stringToBytes(currency)))));
        }
...
export default HomeChargerCommand;