        ...
        while (1) {
          switch (_context2.prev = _context2.next) {
            ...
            case 2:
              ...
              _context2.next = 5;
              return _this.hmkit.crypto.sendTelematicsCommand(hexToUint8Array(serial).buffer, base64ToUint8(nonce).buffer, hexToUint8Array(data.toString()).buffer, _this.onTelematicsSendData);

            case 5:
              result = _context2.sent;
              _context2.next = 8;
              return _this.hmkit.crypto.telematicsDataReceived(base64ToUint8(result).buffer, _this.onTelematicsCommandIncoming);
            ...
            case 8:
              ...
              return _context2.abrupt('return', new Response(response.incomingCommandData));
