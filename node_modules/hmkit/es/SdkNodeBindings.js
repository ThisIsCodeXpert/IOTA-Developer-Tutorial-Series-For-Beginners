  ...
  function SdkNodeBindings(hmkit) {
    ...
    this.callbacks = {
      getser: function getser() {
        return hexToUint8Array(_this.hmkit.clientCertificate.getSerial()).buffer;
      },

      getpriv: function getpriv() {
        return base64ToUint8(_this.hmkit.clientPrivateKey).buffer;
      },

      getac: function getac(serial) {
        var accessCert = _this.hmkit.certificates.get(uint8ArrayToHex(new Uint8Array(serial)).toUpperCase());
