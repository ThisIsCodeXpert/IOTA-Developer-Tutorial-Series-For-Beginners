...
var LightsResponse = function (_PropertyResponse) {
  ...
  function LightsResponse(data) {
    ...
    var properties = [new _Property2.default(0x01, 'frontExteriorLight').setDecoder((0, _helpers.switchDecoder)({
      0x00: 'inactive',
      0x01: 'active',
      0x02: 'active_with_full_beam',
      0x03: 'dlr',
      0x04: 'automatic'
    })), new _Property2.default(0x02, 'rearExteriorLight').setDecoder((0, _helpers.switchDecoder)({
      0x00: 'inactive',
      0x01: 'active'
    })), new _Property2.default(0x04, 'ambientLight').setDecoder(_this.ambientLightDecoder), new _Property2.default(0x05, 'reverseLight').setDecoder((0, _helpers.switchDecoder)({
      0x00: 'inactive',
      0x01: 'active'
    })), new _Property2.default(0x06, 'emergencyBrakeLight').setDecoder((0, _helpers.switchDecoder)({
      0x00: 'inactive',
      0x01: 'active'
    })), new _Property2.default(0x07, 'fogLights').setOptionalSubProperties('location', [new _OptionalProperty2.default(0x00, 'front').setDecoder(_this.lightsDecoder), new _OptionalProperty2.default(0x01, 'rear').setDecoder(_this.lightsDecoder)]), new _Property2.default(0x08, 'readingLamps').setOptionalSubProperties('location', [new _OptionalProperty2.default(0x00, 'front_left').setDecoder(_this.lightsDecoder), new _OptionalProperty2.default(0x01, 'front_right').setDecoder(_this.lightsDecoder), new _OptionalProperty2.default(0x02, 'rear_right').setDecoder(_this.lightsDecoder), new _OptionalProperty2.default(0x03, 'rear_left').setDecoder(_this.lightsDecoder)]), new _Property2.default(0x09, 'interiorLights').setOptionalSubProperties('location', [new _OptionalProperty2.default(0x00, 'front').setDecoder(_this.lightsDecoder), new _OptionalProperty2.default(0x01, 'rear').setDecoder(_this.lightsDecoder)])];
