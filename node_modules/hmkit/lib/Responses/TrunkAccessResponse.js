...
var TrunkAccessResponse = function (_PropertyResponse) {
   ...
   */
  function TrunkAccessResponse(data) {
    ...
    var properties = [new _Property2.default(0x01, 'trunkLock').setDecoder((0, _helpers.switchDecoder)({
      0x00: 'unlocked',
      0x01: 'locked'
    })), new _Property2.default(0x02, 'trunkPosition').setDecoder((0, _helpers.switchDecoder)({
      0x00: 'closed',
      0x01: 'open'
    }))];
