...
var ClimateResponse = function (_PropertyResponse) {
  ...
  function ClimateResponse(data) {
    ...
    var properties = [new _Property2.default(0x01, 'insideTemperature').setDecoder((0, _helpers.getRoundedIeee754ToBase10)(2)), new _Property2.default(0x02, 'outsideTemperature').setDecoder((0, _helpers.getRoundedIeee754ToBase10)(2)), new _Property2.default(0x03, 'driverTemperatureSetting').setDecoder((0, _helpers.getRoundedIeee754ToBase10)(2)), new _Property2.default(0x04, 'passengerTemperatureSetting').setDecoder((0, _helpers.getRoundedIeee754ToBase10)(2)), new _Property2.default(0x05, 'hvacState').setDecoder((0, _helpers.activeInactiveDecoder)()), new _Property2.default(0x06, 'defoggingState').setDecoder((0, _helpers.activeInactiveDecoder)()), new _Property2.default(0x07, 'defrostingState').setDecoder((0, _helpers.activeInactiveDecoder)()), new _Property2.default(0x08, 'ionisingState').setDecoder((0, _helpers.activeInactiveDecoder)()), new _Property2.default(0x09, 'defrostingTemperature').setDecoder((0, _helpers.getRoundedIeee754ToBase10)(2)), new _Property2.default(0x0b, 'hvacWeekdayStartingTimes').setOptionalSubProperties('weekday', [new _OptionalProperty2.default(0x00, 'monday').setDecoder(_this.weekdayDecoder), new _OptionalProperty2.default(0x01, 'tuesday').setDecoder(_this.weekdayDecoder), new _OptionalProperty2.default(0x02, 'wednesday').setDecoder(_this.weekdayDecoder), new _OptionalProperty2.default(0x03, 'thursday').setDecoder(_this.weekdayDecoder), new _OptionalProperty2.default(0x04, 'friday').setDecoder(_this.weekdayDecoder), new _OptionalProperty2.default(0x05, 'saturday').setDecoder(_this.weekdayDecoder), new _OptionalProperty2.default(0x06, 'sunday').setDecoder(_this.weekdayDecoder), new _OptionalProperty2.default(0x07, 'automatic').setDecoder(_this.weekdayDecoder)]), new _Property2.default(0x0c, 'rearTemperatureSetting').setDecoder((0, _helpers.getRoundedIeee754ToBase10)(2))];
...
exports.default = ClimateResponse;