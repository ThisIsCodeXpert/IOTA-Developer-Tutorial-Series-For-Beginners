...
var ParkingTicketResponse = function (_PropertyResponse) {
   ...
   */
  function ParkingTicketResponse(data) {
    ...
    var properties = [new _Property2.default(0x01, 'parkingTicketState').setDecoder((0, _helpers.switchDecoder)({
      0x00: 'ended',
      0x01: 'started'
    })), new _Property2.default(0x02, 'operatorName').setDecoder(_encoding.bytesToString), new _Property2.default(0x03, 'operatorTicketID').setDecoder(_encoding.bytesToString), new _Property2.default(0x04, 'ticketStartTime').setDecoder(_helpers.dateDecoder), new _Property2.default(0x05, 'ticketEndTime').setDecoder(_helpers.dateDecoder)];
...
exports.default = ParkingTicketResponse;