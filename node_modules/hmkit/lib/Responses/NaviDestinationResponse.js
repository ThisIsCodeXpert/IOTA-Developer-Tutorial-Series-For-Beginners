...
var NaviDestinationResponse = function (_PropertyResponse) {
  ...
  function NaviDestinationResponse(data) {
    ...
    var properties = [new _Property2.default(0x07, 'coordinates').setDecoder(_helpers.coordinatesDecoder), new _Property2.default(0x02, 'destinationName').setDecoder(_encoding.bytesToString)];
