...
var FailureMessageResponse = function (_PropertyResponse) {
  ...
  function FailureMessageResponse(data) {
    ...
    var properties = [new _Property2.default(0x01, 'autoApi').setDecoder(_this.failedCapabilityDecoder), new _Property2.default(0x02, 'type'), new _Property2.default(0x03, 'reason').setDecoder(_this.reasonDecoder)];
