...
var CruiseControlResponse = function (_PropertyResponse) {
  ...
  function CruiseControlResponse(data, config) {
    ...
    var properties = [new _PropertyDecoder2.default(0x01, 'cruiseControl').setDecoder((0, _helpers.switchDecoder)({
      0x00: 'inactive',
      0x01: 'active'
    })), new _PropertyDecoder2.default(0x02, 'limiter').setDecoder((0, _helpers.switchDecoder)({
      0x00: 'not_set',
      0x01: 'higher_speed_requested',
      0x02: 'lower_speed_requested',
      0x03: 'speed_fixed'
    })), new _PropertyDecoder2.default(0x03, 'targetSpeed').setDecoder(_helpers.bytesSum), new _PropertyDecoder2.default(0x04, 'acc').setDecoder((0, _helpers.switchDecoder)({
      0x00: 'inactive',
      0x01: 'active'
    })), new _PropertyDecoder2.default(0x05, 'accTargetSpeed').setDecoder(_helpers.bytesSum)];
...
exports.default = CruiseControlResponse;