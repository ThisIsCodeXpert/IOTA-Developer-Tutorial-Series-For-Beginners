...
var OffroadResponse = function (_PropertyResponse) {
  ...
  function OffroadResponse(data) {
    ...
    var properties = [new _Property2.default(0x01, 'routeIncline').setDecoder(_this.routeInclineDecoder), new _Property2.default(0x02, 'wheelSuspension')];
...
exports.default = OffroadResponse;