...
var HistoricalResponse = function (_PropertyResponse) {
  ...
  function HistoricalResponse(data) {
    ...
    var properties = [new _CapabilityProperty2.default(0x01, 'states').setOptionalSubProperties('capabilityIdentifier', Object.entries(_CAPABILITY_IDENTIFIERS2.default).map(function (_ref) {
...
exports.default = HistoricalResponse;