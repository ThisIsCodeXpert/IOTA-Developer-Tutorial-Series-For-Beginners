...
var _CapabilityProperty = require('../CapabilityProperty');

var _CapabilityProperty2 = _interopRequireDefault(_CapabilityProperty);
...
var VehicleStatusResponse = function (_PropertyResponse) {
  ...
  function VehicleStatusResponse(data) {
    ...
    var properties = [new _Property2.default(0x01, 'vin').setDecoder(_encoding.bytesToString), new _Property2.default(0x02, 'powertrain').setDecoder((0, _helpers.switchDecoder)({
      0x00: 'unknown',
      0x01: 'all_electric',
    ...
    })), new _Property2.default(0x03, 'modelName').setDecoder(_encoding.bytesToString), new _Property2.default(0x04, 'name').setDecoder(_encoding.bytesToString), new _Property2.default(0x05, 'licensePlate').setDecoder(_encoding.bytesToString), new _Property2.default(0x06, 'salesDesignation').setDecoder(_encoding.bytesToString), new _Property2.default(0x07, 'modelYear').setDecoder(_helpers.bytesSum), new _Property2.default(0x08, 'colorName').setDecoder(_encoding.bytesToString), new _Property2.default(0x09, 'powerInKw').setDecoder(_helpers.bytesSum), new _Property2.default(0x0a, 'numberOfDoors').setDecoder(_helpers.bytesSum), new _Property2.default(0x0b, 'numberOfSeats').setDecoder(_helpers.bytesSum), new _Property2.default(0x0c, 'engineVolume').setDecoder((0, _helpers.getRoundedIeee754ToBase10)(2)), new _Property2.default(0x0d, 'engineMaxTorque').setDecoder(_helpers.bytesSum), new _Property2.default(0x0e, 'gearbox').setDecoder((0, _helpers.switchDecoder)({
      0x00: 'manual',
      0x01: 'automatic',
      0x02: 'semi_automatic'
    })), new _Property2.default(0x0f, 'displayUnit').setDecoder((0, _helpers.switchDecoder)({
      0x00: 'km',
      0x01: 'miles'
    })), new _Property2.default(0x10, 'driverSeatLocation').setDecoder((0, _helpers.switchDecoder)({
      0x00: 'left',
      0x01: 'right',
      0x02: 'center'
    })), new _Property2.default(0x11, 'equipments').array().setDecoder(_encoding.bytesToString), new _Property2.default(0x12, 'brand').setDecoder(_encoding.bytesToString), new _CapabilityProperty2.default(0x99, 'states').setOptionalSubProperties('capabilityIdentifier', Object.entries(_CAPABILITY_IDENTIFIERS2.default).map(function (_ref) {
      var _ref2 = _slicedToArray(_ref, 2),
          name = _ref2[0],
          identifier = _ref2[1].identifier;

      return new _OptionalProperty2.default(identifier, name).setDecoder(_this.getCapabilityStateDecoder(identifier));
    }))];
