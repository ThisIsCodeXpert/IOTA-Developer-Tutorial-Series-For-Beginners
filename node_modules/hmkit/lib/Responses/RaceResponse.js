...
var RaceResponse = function (_PropertyResponse) {
  ...
  function RaceResponse(data, config) {
    ...
    var properties = [new _PropertyDecoder2.default(0x01, 'accelerations').setOptionalSubProperties('type', [new _OptionalPropertyDecoder2.default(0x00, 'longitudinal_acceleration').setDecoder(_this.accelerationDecoder), new _OptionalPropertyDecoder2.default(0x01, 'lateral_acceleration').setDecoder(_this.accelerationDecoder), new _OptionalPropertyDecoder2.default(0x02, 'front_lateral_acceleration').setDecoder(_this.accelerationDecoder), new _OptionalPropertyDecoder2.default(0x03, 'rear_lateral_acceleration').setDecoder(_this.accelerationDecoder)]), new _PropertyDecoder2.default(0x02, 'understeering').setDecoder(_helpers.progressDecoder), new _PropertyDecoder2.default(0x03, 'oversteering').setDecoder(_helpers.progressDecoder), new _PropertyDecoder2.default(0x04, 'gasPedalPosition').setDecoder(_helpers.progressDecoder), new _PropertyDecoder2.default(0x05, 'steeringAngle').setDecoder(_encoding.uint8toInt8), new _PropertyDecoder2.default(0x06, 'brakePressure').setDecoder((0, _helpers.getRoundedIeee754ToBase10)(2)), new _PropertyDecoder2.default(0x07, 'yawRate').setDecoder((0, _helpers.getRoundedIeee754ToBase10)(2)), new _PropertyDecoder2.default(0x08, 'rearSuspensionSteering').setDecoder(_encoding.uint8toInt8), new _PropertyDecoder2.default(0x09, 'electronicStabilityProgram').setDecoder((0, _helpers.activeInactiveDecoder)()), new _PropertyDecoder2.default(0x0a, 'brakeTorqueVectorings').setOptionalSubProperties('axle', [new _OptionalPropertyDecoder2.default(0x00, 'front_axle').setDecoder(_this.axleDecoder), new _OptionalPropertyDecoder2.default(0x01, 'rear_axle').setDecoder(_this.axleDecoder)]), new _PropertyDecoder2.default(0x0b, 'gearMode').setDecoder((0, _helpers.switchDecoder)({
      0x00: 'manual',
      0x01: 'park',
      0x02: 'reverse',
      0x03: 'neutral',
      ...
      0x05: 'low_gear',
      0x06: 'sport'
    })), new _PropertyDecoder2.default(0x0c, 'selectedGear'), new _PropertyDecoder2.default(0x0d, 'brakePedalPosition').setDecoder(_helpers.progressDecoder), new _PropertyDecoder2.default(0x0e, 'brakePedalSwitch').setDecoder((0, _helpers.switchDecoder)({
      0x00: 'inactive',
      0x01: 'active'
    })), new _PropertyDecoder2.default(0x0f, 'clutchPedalSwitch').setDecoder((0, _helpers.switchDecoder)({
      0x00: 'inactive',
      0x01: 'active'
    })), new _PropertyDecoder2.default(0x10, 'acceleratorPedalIdleSwitch').setDecoder((0, _helpers.switchDecoder)({
      0x00: 'inactive',
      0x01: 'active'
    })), new _PropertyDecoder2.default(0x11, 'acceleratorPedalKickdownSwitch').setDecoder((0, _helpers.switchDecoder)({
      0x00: 'inactive',
      0x01: 'active'
    })), new _PropertyDecoder2.default(0x12, 'vehicleMoving').setDecoder((0, _helpers.switchDecoder)({
      0x00: 'not_moving',
      0x01: 'moving'
    }))];
  ...
  _createClass(RaceResponse, [{
    ...
    value: function axleDecoder(bytes) {
      return {
        vectoring: (0, _helpers.switchDecoder)({
          0x00: 'inactive',
          0x01: 'active'
        })(bytes)
      };
    ...
    value: function accelerationDecoder() {
      var decoder = (0, _helpers.getRoundedIeee754ToBase10)(3);
