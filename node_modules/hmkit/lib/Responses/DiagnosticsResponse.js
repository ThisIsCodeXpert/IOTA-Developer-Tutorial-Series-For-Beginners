...
var DiagnosticsResponse = function (_PropertyResponse) {
  ...
  function DiagnosticsResponse(data) {
    ...
    var properties = [new _Property2.default(0x01, 'mileage').setDecoder(_helpers.bytesSum), new _Property2.default(0x02, 'engineOilTemperature').setDecoder(_helpers.bytesSum), new _Property2.default(0x03, 'speed').setDecoder(_helpers.bytesSum), new _Property2.default(0x04, 'engineRPM').setDecoder(_helpers.bytesSum), new _Property2.default(0x05, 'fuelLevel').setDecoder(_helpers.progressDecoder), new _Property2.default(0x06, 'estimatedRange').setDecoder(_helpers.bytesSum), new _Property2.default(0x09, 'washerFluidLevel').setDecoder((0, _helpers.switchDecoder)({
      0x00: 'low',
      0x01: 'filled'
    })), new _Property2.default(0x0b, 'batteryVoltage').setDecoder((0, _helpers.getRoundedIeee754ToBase10)(2)), new _Property2.default(0x0c, 'adblueLevel').setDecoder((0, _helpers.getRoundedIeee754ToBase10)(2)), new _Property2.default(0x0d, 'distanceSinceReset').setDecoder(_helpers.bytesSum), new _Property2.default(0x0e, 'distanceSinceStart').setDecoder(_helpers.bytesSum), new _Property2.default(0x0f, 'fuelVolume').setDecoder((0, _helpers.getRoundedIeee754ToBase10)(2)), new _Property2.default(0x10, 'antiLockBraking').setDecoder((0, _helpers.switchDecoder)({
      0x00: 'inactive',
      0x01: 'active'
    })), new _Property2.default(0x11, 'engineCoolantTemperature').setDecoder(_helpers.uint8Decoder), new _Property2.default(0x12, 'engineTotalOperatingHours').setDecoder((0, _helpers.getRoundedIeee754ToBase10)(2)), new _Property2.default(0x13, 'engineTotalFuelConsumption').setDecoder((0, _helpers.getRoundedIeee754ToBase10)(2)), new _Property2.default(0x14, 'brakeFluidLevel').setDecoder((0, _helpers.switchDecoder)({
      0x00: 'low',
      0x01: 'filled'
    })), new _Property2.default(0x15, 'engineTorque').setDecoder(_helpers.progressDecoder), new _Property2.default(0x16, 'engineLoad').setDecoder(_helpers.progressDecoder), new _Property2.default(0x17, 'wheelBasedSpeed').setDecoder(_helpers.bytesSum), new _Property2.default(0x18, 'batteryLevel').setDecoder(_helpers.progressDecoder), new _Property2.default(0x19, 'checkControlMessages').setDecoder(_this.checkControlMessagesDecoder), new _Property2.default(0x1a, 'tirePressures').setOptionalSubProperties('location', [new _OptionalProperty2.default(0x00, 'front_left').setDecoder(_this.pressureDecoder), new _OptionalProperty2.default(0x01, 'front_right').setDecoder(_this.pressureDecoder), new _OptionalProperty2.default(0x02, 'rear_right').setDecoder(_this.pressureDecoder), new _OptionalProperty2.default(0x03, 'rear_left').setDecoder(_this.pressureDecoder)]), new _Property2.default(0x1b, 'tireTemperatures').setOptionalSubProperties('location', [new _OptionalProperty2.default(0x00, 'front_left').setDecoder(_this.temperatureDecoder), new _OptionalProperty2.default(0x01, 'front_right').setDecoder(_this.temperatureDecoder), new _OptionalProperty2.default(0x02, 'rear_right').setDecoder(_this.temperatureDecoder), new _OptionalProperty2.default(0x03, 'rear_left').setDecoder(_this.temperatureDecoder)]), new _Property2.default(0x1c, 'wheelRpms').setOptionalSubProperties('location', [new _OptionalProperty2.default(0x00, 'front_left').setDecoder(_this.rpmDecoder), new _OptionalProperty2.default(0x01, 'front_right').setDecoder(_this.rpmDecoder), new _OptionalProperty2.default(0x02, 'rear_right').setDecoder(_this.rpmDecoder), new _OptionalProperty2.default(0x03, 'rear_left').setDecoder(_this.rpmDecoder)]), new _Property2.default(0x1d, 'troubleCodes').setDecoder(_this.troubleCodesDecoder), new _Property2.default(0x1e, 'mileageMeters').setDecoder(_helpers.bytesSum)];
