...
var EngineResponse = function (_PropertyResponse) {
  ...
  function EngineResponse(data) {
    ...
    var properties = [new _Property2.default(0x01, 'ignition').setDecoder((0, _helpers.switchDecoder)({
      0x00: 'engine_off',
      0x01: 'engine_on'
    })), new _Property2.default(0x02, 'accessoriesIgnition').setDecoder((0, _helpers.switchDecoder)({
      0x00: 'powered_off',
      0x01: 'powered_on'
    }))];
