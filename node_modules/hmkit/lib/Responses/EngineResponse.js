...
var EngineResponse = function (_PropertyResponse) {
   ...
   */
  function EngineResponse(data, config) {
    ...
    var properties = [new _PropertyDecoder2.default(0x01, 'ignition').setDecoder((0, _helpers.switchDecoder)({
      0x00: 'off',
      0x01: 'on'
    })), new _PropertyDecoder2.default(0x02, 'accessoriesIgnition').setDecoder((0, _helpers.switchDecoder)({
      0x00: 'off',
      0x01: 'on'
    }))];
