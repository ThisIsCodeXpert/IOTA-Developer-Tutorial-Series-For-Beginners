...
var WindscreenResponse = function (_PropertyResponse) {
   ...
   */
  function WindscreenResponse(data) {
    ...
    var properties = [new _Property2.default(0x01, 'wipers').setDecoder((0, _helpers.switchDecoder)({
      0x00: 'inactive',
      0x01: 'active',
      0x02: 'automatic'
    })), new _Property2.default(0x02, 'wipersIntensity').setDecoder((0, _helpers.switchDecoder)({
      0x00: 'level_0',
      0x01: 'level_1',
      0x02: 'level_2',
      0x03: 'level_3'
    })), new _Property2.default(0x03, 'windscreenDamage').setDecoder((0, _helpers.switchDecoder)({
      0x00: 'no_impact_detected',
      0x01: 'impact_but_no_damage_detected',
      0x02: 'damage_smaller_than_1_inch',
      0x03: 'damage_larger_than_1_inch'
    })), new _Property2.default(0x04, 'windscreenZoneMatrix').setDecoder(_helpers.matrixZoneDecoder), new _Property2.default(0x05, 'windscreenDamageZone').setDecoder(_helpers.matrixZoneDecoder), new _Property2.default(0x06, 'windscreenNeedsReplacement').setDecoder((0, _helpers.switchDecoder)({
      0x00: 'unknown',
      0x01: 'no_replacement_needed',
      0x02: 'replacement_needed'
    })), new _Property2.default(0x07, 'windscreenDamageConfidence'), new _Property2.default(0x08, 'windscreenDamageDetectionTime').setDecoder(_helpers.dateDecoder)];
...
exports.default = WindscreenResponse;