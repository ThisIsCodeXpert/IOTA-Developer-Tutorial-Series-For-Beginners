...
function _inherits(subClass, superClass) { if (typeof superClass !== "function" && superClass !== null) { throw new TypeError("Super expression must either be null or a function, not " + typeof superClass); } subClass.prototype = Object.create(superClass && superClass.prototype, { constructor: { value: subClass, enumerable: false, writable: true, configurable: true } }); if (superClass) Object.setPrototypeOf ? Object.setPrototypeOf(subClass, superClass) : subClass.__proto__ = superClass; } /* eslint-disable no-useless-computed-key */
...
var CapabilitiesResponse = function (_PropertyResponse) {
   ...
   */
  function CapabilitiesResponse(data) {
    ...
    var properties = [new _CapabilityProperty2.default(0x01, 'capabilities').setOptionalSubProperties('capabilityIdentifier', Object.entries(_CAPABILITY_IDENTIFIERS2.default).map(function (_ref) {
      var _ref2 = _slicedToArray(_ref, 2),
          name = _ref2[0],
          identifier = _ref2[1].identifier;

      return new _OptionalProperty2.default(identifier, name).setDecoder(_this.getCapabilityDecoder(name));
    }))];
      ...
      return function (bytes) {
        return {
          supportedMessageTypes: bytes.map(function (byte) {
            return _CAPABILITY_IDENTIFIERS2.default[capability].messages[byte];
          })
        };
      };
    }
...
exports.default = CapabilitiesResponse;