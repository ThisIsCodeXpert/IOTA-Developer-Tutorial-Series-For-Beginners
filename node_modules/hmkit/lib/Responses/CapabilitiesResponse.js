...
var CapabilitiesResponse = function (_PropertyResponse) {
  ...
  function CapabilitiesResponse(data, config) {
    ...
    var properties = [new _CapabilityPropertyDecoder2.default(0x01, 'capabilities').setOptionalSubProperties('capabilityIdentifier', Object.entries(_CAPABILITY_IDENTIFIERS2.default).map(function (_ref) {
      var _ref2 = _slicedToArray(_ref, 2),
          name = _ref2[0],
          identifier = _ref2[1].identifier;

      return new _OptionalPropertyDecoder2.default(identifier, name).setDecoder(_this.getCapabilityDecoder(name));
    }))];
