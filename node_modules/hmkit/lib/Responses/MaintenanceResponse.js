...
var MaintenanceResponse = function (_PropertyResponse) {
  ...
  function MaintenanceResponse(data) {
    ...
    var properties = [new _Property2.default(0x01, 'daysToNextService').setDecoder(_helpers.bytesSum), new _Property2.default(0x02, 'kilometersToNextService').setDecoder(_helpers.bytesSum), new _Property2.default(0x03, 'cbsReportsCount').setDecoder(_helpers.bytesSum), new _Property2.default(0x04, 'monthsToExhaustInspection').setDecoder(_helpers.bytesSum), new _Property2.default(0x05, 'teleserviceAvailability').setDecoder((0, _helpers.switchDecoder)({
      0x00: 'pending',
      0x01: 'idle',
      0x02: 'succesful',
      0x03: 'error'
    })), new _Property2.default(0x06, 'serviceDistanceThreshold').setDecoder(_helpers.bytesSum), new _Property2.default(0x07, 'serviceTimeThreshold').setDecoder(_helpers.bytesSum), new _Property2.default(0x08, 'automaticTeleserviceCallDate').setDecoder(_helpers.dateDecoder), new _Property2.default(0x09, 'teleserviceBatteryCallDate').setDecoder(_helpers.dateDecoder), new _Property2.default(0x0a, 'nextInspectionDate').setDecoder(_helpers.dateDecoder), new _Property2.default(0x0b, 'conditionBasedServices').setDecoder(_this.conditionBasedServicesDecoder), new _Property2.default(0x0c, 'brakeFluidChangeDate').setDecoder(_helpers.dateDecoder)];
