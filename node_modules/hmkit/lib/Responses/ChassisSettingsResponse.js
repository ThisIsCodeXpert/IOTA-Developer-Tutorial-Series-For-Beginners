...
var ChassisSettingsResponse = function (_PropertyResponse) {
   ...
   */
  function ChassisSettingsResponse(data) {
    ...
    var properties = [new _Property2.default(0x01, 'drivingMode').setDecoder((0, _helpers.switchDecoder)({
      0x00: 'regular',
      0x01: 'eco',
      0x02: 'sport',
      0x03: 'sport_plus',
      0x04: 'eco_plus'
    })), new _Property2.default(0x02, 'sportChrono').setDecoder((0, _helpers.switchDecoder)({
      0x00: 'inactive',
      0x01: 'active'
    })), new _Property2.default(0x05, 'currentSpringRates').setOptionalSubProperties('axle', [new _OptionalProperty2.default(0x00, 'front_axle').setDecoder(_this.axleDataDecoder('springRate')), new _OptionalProperty2.default(0x01, 'rear_axle').setDecoder(_this.axleDataDecoder('springRate'))]), new _Property2.default(0x06, 'maximumSpringRates').setOptionalSubProperties('axle', [new _OptionalProperty2.default(0x00, 'front_axle').setDecoder(_this.axleDataDecoder('springRate')), new _OptionalProperty2.default(0x01, 'rear_axle').setDecoder(_this.axleDataDecoder('springRate'))]), new _Property2.default(0x07, 'minimumSpringRates').setOptionalSubProperties('axle', [new _OptionalProperty2.default(0x00, 'front_axle').setDecoder(_this.axleDataDecoder('springRate')), new _OptionalProperty2.default(0x01, 'rear_axle').setDecoder(_this.axleDataDecoder('springRate'))]), new _Property2.default(0x08, 'currentChassisPosition').setDecoder(function (bytes) {
      return (0, _encoding.uint8toInt8)(bytes[0]);
    }), new _Property2.default(0x09, 'maximumChassisPosition').setDecoder(function (bytes) {
      return (0, _encoding.uint8toInt8)(bytes[0]);
    }), new _Property2.default(0x0a, 'minimumChassisPosition').setDecoder(function (bytes) {
      return (0, _encoding.uint8toInt8)(bytes[0]);
    })];
