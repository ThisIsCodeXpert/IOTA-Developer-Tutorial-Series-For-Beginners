...
var WiFiResponse = function (_PropertyResponse) {
  ...
  function WiFiResponse(data) {
    ...
    var properties = [new _Property2.default(0x01, 'wifiEnabled').setDecoder((0, _helpers.switchDecoder)({
      0x00: 'disabled',
      0x01: 'enabled'
    })), new _Property2.default(0x02, 'networkConnected').setDecoder((0, _helpers.switchDecoder)({
      0x00: 'disconnected',
      0x01: 'connected'
    })), new _Property2.default(0x03, 'networkSSID').setDecoder(_encoding.bytesToString), new _Property2.default(0x04, 'networkSecurity').setDecoder((0, _helpers.switchDecoder)({
      0x00: 'none',
      0x01: 'wep',
      0x02: 'wpa',
      0x03: 'wpa2_personal'
