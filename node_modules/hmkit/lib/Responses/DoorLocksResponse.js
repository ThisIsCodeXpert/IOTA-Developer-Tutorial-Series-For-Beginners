...
var DoorLocksResponse = function (_PropertyResponse) {
  ...
  function DoorLocksResponse(data, config) {
    ...
    var properties = [new _PropertyDecoder2.default(0x02, 'insideLocks').setOptionalSubProperties('doorLocation', [new _OptionalPropertyDecoder2.default(0x00, 'front_left').setDecoder(_this.lockDecoder), new _OptionalPropertyDecoder2.default(0x01, 'front_right').setDecoder(_this.lockDecoder), new _OptionalPropertyDecoder2.default(0x02, 'rear_right').setDecoder(_this.lockDecoder), new _OptionalPropertyDecoder2.default(0x03, 'rear_left').setDecoder(_this.lockDecoder), new _OptionalPropertyDecoder2.default(0x05, 'all').setDecoder(_this.lockDecoder)]), new _PropertyDecoder2.default(0x03, 'locks').setOptionalSubProperties('doorLocation', [new _OptionalPropertyDecoder2.default(0x00, 'front_left').setDecoder(_this.lockDecoder), new _OptionalPropertyDecoder2.default(0x01, 'front_right').setDecoder(_this.lockDecoder), new _OptionalPropertyDecoder2.default(0x02, 'rear_right').setDecoder(_this.lockDecoder), new _OptionalPropertyDecoder2.default(0x03, 'rear_left').setDecoder(_this.lockDecoder), new _OptionalPropertyDecoder2.default(0x05, 'all').setDecoder(_this.lockDecoder)]), new _PropertyDecoder2.default(0x04, 'positions').setOptionalSubProperties('doorLocation', [new _OptionalPropertyDecoder2.default(0x00, 'front_left').setDecoder(_this.positionDecoder), new _OptionalPropertyDecoder2.default(0x01, 'front_right').setDecoder(_this.positionDecoder), new _OptionalPropertyDecoder2.default(0x02, 'rear_right').setDecoder(_this.positionDecoder), new _OptionalPropertyDecoder2.default(0x03, 'rear_left').setDecoder(_this.positionDecoder), new _OptionalPropertyDecoder2.default(0x05, 'all').setDecoder(_this.positionDecoder)])];
    /* prettier-ignore-end */
  ...
  _createClass(DoorLocksResponse, [{
    ...
    value: function positionDecoder(data) {
      return {
        position: (0, _helpers.switchDecoder)({
          0x00: 'closed',
          0x01: 'open'
        })(data)
      };
    ...
    value: function lockDecoder(data) {
      return {
        lockState: (0, _helpers.switchDecoder)({
          0x00: 'unlocked',
          0x01: 'locked'
        })(data)
      };
