...
var PowerTakeOffResponse = function (_PropertyResponse) {
   ...
   */
  function PowerTakeOffResponse(data) {
    ...
    var properties = [new _Property2.default(0x01, 'powerTakeoff').setDecoder((0, _helpers.switchDecoder)({
      0x00: 'inactive',
      0x01: 'active'
    })), new _Property2.default(0x02, 'powerTakeoffEngaged').setDecoder((0, _helpers.switchDecoder)({
      0x00: 'not_engaged',
      0x01: 'engaged'
    }))];
