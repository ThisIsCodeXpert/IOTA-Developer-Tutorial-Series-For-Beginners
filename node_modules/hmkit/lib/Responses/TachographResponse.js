...
var TachographResponse = function (_PropertyResponse) {
  ...
  */
  function TachographResponse(data) {
    ...
    var properties = [new _Property2.default(0x01, 'driverWorkingStates').setOptionalSubProperties('driverNumber', [new _OptionalProperty2.default(0x01, 1).setDecoder(_this.driverWorkingStateDecoder), new _OptionalProperty2.default(0x02, 2).setDecoder(_this.driverWorkingStateDecoder)]), new _Property2.default(0x02, 'driverTimeStates').setOptionalSubProperties('driverNumber', [new _OptionalProperty2.default(0x01, 1).setDecoder(_this.driverTimeStateDecoder), new _OptionalProperty2.default(0x02, 2).setDecoder(_this.driverTimeStateDecoder)]), new _Property2.default(0x03, 'driverCards').setOptionalSubProperties('driverNumber', [new _OptionalProperty2.default(0x01, 1).setDecoder(_this.driverCardDecoder), new _OptionalProperty2.default(0x02, 2).setDecoder(_this.driverCardDecoder)]), new _Property2.default(0x04, 'vehicleMotion').setDecoder((0, _helpers.switchDecoder)({
      0x00: 'not_detected',
      0x01: 'detected'
    })), new _Property2.default(0x05, 'vehicleOverspeed').setDecoder((0, _helpers.switchDecoder)({
      0x00: 'no_overspeed',
      0x01: 'overspeed'
    })), new _Property2.default(0x06, 'vehicleDirection').setDecoder((0, _helpers.switchDecoder)({
      0x00: 'forward',
      0x01: 'reverse'
    })), new _Property2.default(0x07, 'vehicleSpeed').setDecoder(_helpers.bytesSum)];
  ...
  _createClass(TachographResponse, [{
    ...
    value: function driverWorkingStateDecoder(data) {
      return {
        workingState: (0, _helpers.switchDecoder)({
          0x00: 'resting',
    ...
    value: function driverTimeStateDecoder(data) {
      return {
        timeState: (0, _helpers.switchDecoder)({
          0x00: 'normal',
...
exports.default = TachographResponse;