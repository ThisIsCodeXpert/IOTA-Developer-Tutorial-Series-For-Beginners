...
var WindowsResponse = function (_PropertyResponse) {
  ...
  function WindowsResponse(data) {
    ...
    var properties = [new _Property2.default(0x02, 'windowsOpenPercentages').setOptionalSubProperties('windowLocation', [new _OptionalProperty2.default(0x00, 'front_left').setDecoder(_this.openPercentageDecoder), new _OptionalProperty2.default(0x01, 'front_right').setDecoder(_this.openPercentageDecoder), new _OptionalProperty2.default(0x02, 'rear_right').setDecoder(_this.openPercentageDecoder), new _OptionalProperty2.default(0x03, 'rear_left').setDecoder(_this.openPercentageDecoder), new _OptionalProperty2.default(0x04, 'hatch').setDecoder(_this.openPercentageDecoder)]), new _Property2.default(0x03, 'windowsPositions').setOptionalSubProperties('windowLocation', [new _OptionalProperty2.default(0x00, 'front_left').setDecoder(_this.positionDecoder), new _OptionalProperty2.default(0x01, 'front_right').setDecoder(_this.positionDecoder), new _OptionalProperty2.default(0x02, 'rear_right').setDecoder(_this.positionDecoder), new _OptionalProperty2.default(0x03, 'rear_left').setDecoder(_this.positionDecoder), new _OptionalProperty2.default(0x04, 'hatch').setDecoder(_this.positionDecoder)])];
