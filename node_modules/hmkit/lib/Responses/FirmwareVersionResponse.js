...
var FirmwareVersionResponse = function (_PropertyResponse) {
   ...
   */
  function FirmwareVersionResponse(data) {
    ...
    var properties = [new _Property2.default(0x01, 'carSDKVersion').setDecoder(_this.carSDKVersionDecoder), new _Property2.default(0x02, 'carSDKBuildName').setDecoder(_encoding.bytesToString), new _Property2.default(0x03, 'applicationVersion').setDecoder(_encoding.bytesToString)];
