...
var PropertyResponse = function () {
  ...
  _createClass(PropertyResponse, [{
    ...
    value: function parse(data, properties) {
      this.bindProperties(this.parseProperties(data, properties).filter(function (property) {
        return property.value !== null && property.value !== undefined || property.subProperties.length > 0;
      }));
    }
    ...
    key: 'bindProperties',
    value: function bindProperties(properties) {
      var _this = this;

      properties.forEach(function (property) {
        _this[property.namespace] = property.getValue();
      });
    }
    ...
    value: function parseProperties(data, properties) {
      ...
      if (propertiesData.length > 0) {
        ...
        while (counter < propertiesData.length) {
          ...
          var propertyDataLength = (0, _helpers.bytesSum)(propertiesData.slice(counter + 1, counter + 3));
          var propertyData = propertiesData.slice(counter + 3, counter + 3 + propertyDataLength);
