...
var LightsCommand = function (_BaseCommand) {
  ...
  _createClass(LightsCommand, null, [{
    ...
    value: function getState() {
      return new _Command2.default([0x00, 0x36, 0x00]);
    }
    ...
    value: function control(frontExteriorLight, rearExteriorLight, ambientLight, fogLights, readingLamps, interiorLights) {
      ...
      if (!!ambientLight && ambientLight.length > 0) {
        var red = (0, _encoding.hexToInt)(ambientLight.slice(1, 3));
        var green = (0, _encoding.hexToInt)(ambientLight.slice(3, 5));
        var blue = (0, _encoding.hexToInt)(ambientLight.slice(5, 7));
      ...
      return new _Command2.default([0x00, 0x36, 0x12].concat(_toConsumableArray(allFrontBytes), _toConsumableArray(allRearBytes), _toConsumableArray(allAmbientBytes), _toConsumableArray(allFogLightsBytes), _toConsumableArray(allReadingLampsBytes), _toConsumableArray(allInteriorLightsBytes)));
    }
  }]);
