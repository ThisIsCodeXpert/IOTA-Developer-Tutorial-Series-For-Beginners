...
var WindscreenCommand = function (_BaseCommand) {
  ...
  _createClass(WindscreenCommand, null, [{
    ...
    value: function getState() {
      return new _Command2.default([0x00, 0x42, 0x00]);
    }
    ...
    value: function setDamage(damage, damageZoneRow, damageZoneColumn) {
      (0, _validate.validate)([{
        value: damage,
        name: 'Damage',
        condition: _validate.Joi.string().required()
      }, {
        value: damageZoneRow,
      ...
      return new _Command2.default([0x00, 0x42, 0x12].concat(_toConsumableArray(this.buildProperty(0x01, this.getDamageByte(damage))), _toConsumableArray(this.buildProperty(0x02, ((damageZoneRow & 0x0f) << 4) + (damageZoneColumn & 0x0f)))));
    }
    ...
    value: function setReplacement(needsReplacement) {
      ...
      return new _Command2.default([0x00, 0x42, 0x13].concat(_toConsumableArray(this.buildProperty(0x01, this.getNeedReplacementByte(needsReplacement)))));
    }
    ...
    value: function controlWipers(wipersState, wipersIntensity) {
      (0, _validate.validate)([{
        ...
        condition: _validate.Joi.string()
      }]);
      ...
      return new _Command2.default([0x00, 0x42, 0x14].concat(_toConsumableArray(this.buildProperty(0x01, this.getWiperStateByte(wipersState))), _toConsumableArray(wipersIntensityBytes)));
    }
  }, {
    key: 'getDamageByte',
...
exports.default = WindscreenCommand;