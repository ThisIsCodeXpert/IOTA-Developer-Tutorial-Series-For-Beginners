...
var NaviDestinationCommand = function (_BaseCommand) {
  ...
  _createClass(NaviDestinationCommand, null, [{
    ...
    value: function getDestination() {
      return new _Command2.default([0x00, 0x31, 0x00]);
    }
    ...
    value: function setDestination(latitude, longitude) {
      ...
      var nameBytes = destinationName.length > 0 ? this.buildProperty(0x02, destinationName, _encoding.stringToBytes) : [];

      return new _Command2.default([0x00, 0x31, 0x12].concat(_toConsumableArray(this.buildProperty(0x01, [].concat(_toConsumableArray((0, _encoding.base10ToIeee754Double)(latitude)), _toConsumableArray((0, _encoding.base10ToIeee754Double)(longitude))))), _toConsumableArray(nameBytes)));
    }
  }]);
...
exports.default = NaviDestinationCommand;