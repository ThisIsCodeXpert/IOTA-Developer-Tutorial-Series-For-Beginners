...
var NotificationCommand = function (_BaseCommand) {
  ...
  _createClass(NotificationCommand, null, [{
    ...
    value: function send(text, actions) {
      return new _Command2.default([0x00, 0x38, 0x00].concat(_toConsumableArray(this.buildProperty(0x01, (0, _encoding.stringToBytes)(text))), _toConsumableArray(this.getActionsBytes(actions))));
    }
    ...
    value: function clear() {
      return new _Command2.default([0x00, 0x38, 0x02]);
    }
  }, {
    key: 'getActionsBytes',
    value: function getActionsBytes(actions) {
      ...
      return Object.entries(actions).reduce(function (actionBytes, _ref) {
        ...
        return actionBytes.concat(_this2.buildProperty(0x02, [actionId].concat(_toConsumableArray((0, _encoding.stringToBytes)(actionName)))));
      }, []);
    }
  }]);
