...
var PowerTakeOffCommand = function (_BaseCommand) {
  ...
  _createClass(PowerTakeOffCommand, null, [{
    ...
    value: function getState() {
      return new _Command2.default([0x00, 0x65, 0x00]);
    }
    ...
    value: function activate() {
      return new _Command2.default([0x00, 0x65, 0x02].concat(_toConsumableArray(this.buildProperty(0x01, 0x01))));
    }
    ...
    value: function deactivate() {
      return new _Command2.default([0x00, 0x65, 0x02].concat(_toConsumableArray(this.buildProperty(0x01, 0x00))));
    }
  }]);
...
exports.default = PowerTakeOffCommand;