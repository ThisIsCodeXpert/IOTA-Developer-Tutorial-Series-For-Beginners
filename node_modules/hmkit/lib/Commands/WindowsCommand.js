...
var WindowsCommand = function (_BaseCommand) {
  ...
  _createClass(WindowsCommand, null, [{
    ...
    value: function getState() {
      return new _Command2.default([0x00, 0x45, 0x00]);
    }
    ...
    value: function control(openPercentages, windowPositions) {
      return new _Command2.default([0x00, 0x45, 0x12].concat(_toConsumableArray(this.getWindowOpenPercentageBytes(openPercentages)), _toConsumableArray(this.getWindowPositionBytes(windowPositions))));
    }
  }, {
    ...
    value: function getWindowOpenPercentageBytes(openPercentages) {
      ...
      if (!!openPercentages && Array.isArray(openPercentages)) {
        ...
        return (_ref = []).concat.apply(_ref, _toConsumableArray(openPercentages.map(function (_ref2) {
          ...
          return _this2.buildProperty(0x01, [_this2.getWindowLocationByte(windowLocation)].concat(_toConsumableArray((0, _encoding.percentageToDouble)(openPercentage))));
        })));
      }
...
exports.default = WindowsCommand;