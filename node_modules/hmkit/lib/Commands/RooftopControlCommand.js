...
var RooftopControlCommand = function (_BaseCommand) {
  ...
  _createClass(RooftopControlCommand, null, [{
    ...
    value: function getState() {
      return new _Command2.default([0x00, 0x25, 0x00]);
    }
    ...
    value: function control(dimming, position, convertibleRoof, sunroofTilt, sunroofState) {
      var dimmingBytes = typeof dimming !== 'number' ? [] : this.buildProperty(0x01, (0, _encoding.percentageToDouble)(dimming));

      var positionBytes = typeof position !== 'number' ? [] : this.buildProperty(0x02, (0, _encoding.percentageToDouble)(position));
      ...
      if (!!convertibleRoof) {
        ...
        (0, _validate.validate)([{
          ...
          condition: (_Joi$string = _validate.Joi.string()).valid.apply(_Joi$string, _toConsumableArray(Object.keys(convertibleRoofOptions)))
        }]);
      ...
      if (!!sunroofTilt) {
        ...
        (0, _validate.validate)([{
          value: sunroofTilt,
          name: 'Sunroof tilt',
          condition: (_Joi$string2 = _validate.Joi.string()).valid.apply(_Joi$string2, _toConsumableArray(Object.keys(sunroofTiltOptions)))
        }]);
      ...
      if (!!sunroofState) {
        ...
        (0, _validate.validate)([{
          value: sunroofState,
          name: 'Sunroof state',
          condition: (_Joi$string3 = _validate.Joi.string()).valid.apply(_Joi$string3, _toConsumableArray(Object.keys(sunroofStateOptions)))
        }]);

        sunroofStateBytes = this.buildProperty(0x05, sunroofStateOptions[sunroofState]);
      }

      return new _Command2.default([0x00, 0x25, 0x12].concat(_toConsumableArray(dimmingBytes), _toConsumableArray(positionBytes), _toConsumableArray(convertibleRoofBytes), _toConsumableArray(sunroofTiltBytes), _toConsumableArray(sunroofStateBytes)));
    }
  }]);
...
exports.default = RooftopControlCommand;