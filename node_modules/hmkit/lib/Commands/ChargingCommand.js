...
var ChargingCommand = function (_BaseCommand) {
  ...
  _createClass(ChargingCommand, null, [{
    ...
    value: function getChargeState() {
      return new _Command2.default([0x00, 0x23, 0x00]);
    }
    ...
    value: function startCharging() {
      return new _Command2.default([0x00, 0x23, 0x12].concat(_toConsumableArray(this.buildProperty(0x01, 0x01))));
    }
    ...
    value: function stopCharging() {
      return new _Command2.default([0x00, 0x23, 0x12].concat(_toConsumableArray(this.buildProperty(0x01, 0x00))));
    }
    ...
    value: function setChargeLimit(limit) {
      (0, _validate.validate)([{
        value: limit,
        name: 'Limit',
        condition: _validate.Joi.number().min(0).max(100).required()
      }]);

      return new _Command2.default([0x00, 0x23, 0x13].concat(_toConsumableArray(this.buildProperty(0x01, (0, _encoding.percentageToDouble)(limit)))));
    }
    ...
    value: function openChargePort() {
      return new _Command2.default([0x00, 0x23, 0x14].concat(_toConsumableArray(this.buildProperty(0x01, 0x01))));
    }
    ...
    value: function closeChargePort() {
      return new _Command2.default([0x00, 0x23, 0x14].concat(_toConsumableArray(this.buildProperty(0x01, 0x00))));
    }
    ...
    value: function setChargeMode(chargeMode) {
      (0, _validate.validate)([{
        value: chargeMode,
        name: 'Charge mode',
        condition: _validate.Joi.string().valid('immediate', 'timer_based', 'inductive').required()
      }]);
      ...
      return new _Command2.default([0x00, 0x23, 0x15].concat(_toConsumableArray(this.buildProperty(0x01, chargeModeOptions[chargeMode]))));
    }
    ...
    value: function setChargeTimers(chargeTimers) {
      ...
      var chargeTimerProperties = chargeTimers.reduce(function (allTimers, _ref) {
        ...
        (0, _validate.validate)([{
          value: timerType,
          name: 'Timer type',
          condition: (_Joi$string = _validate.Joi.string()).valid.apply(_Joi$string, _toConsumableArray(Object.keys(chargeTimerOptions)))
        }]);

        return allTimers.concat(_this2.buildProperty(0x0d, [chargeTimerOptions[timerType]].concat(_toConsumableArray((0, _encoding.dateToBytes)(time)))));
      }, []);

      return new _Command2.default([0x00, 0x23, 0x16].concat(_toConsumableArray(chargeTimerProperties)));
    }
  }, {
    ...
    value: function setReductionOfChargingCurrentTimes(reductionTimes) {
      ...
      var reductionTimeProperties = reductionTimes.reduce(function (allTimers, _ref2) {
        ...
        (0, _validate.validate)([{
          ...
          condition: (_Joi$string2 = _validate.Joi.string()).valid.apply(_Joi$string2, _toConsumableArray(Object.keys(startStopOptions)))
        }]);

        return allTimers.concat(_this3.buildProperty(0x01, [startStopOptions[startStop], hour, minute]));
      }, []);

      return new _Command2.default([0x00, 0x23, 0x17].concat(_toConsumableArray(reductionTimeProperties)));
    }
  }]);
...
exports.default = ChargingCommand;