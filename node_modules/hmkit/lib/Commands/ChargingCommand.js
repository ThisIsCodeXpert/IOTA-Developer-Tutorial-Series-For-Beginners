...
var ChargingCommand = function (_BaseCommand) {
  ...
  _createClass(ChargingCommand, null, [{
    ...
    value: function setChargeLimit(limit) {
      ...
      return new _Command2.default([0x00, 0x23, 0x13].concat(_toConsumableArray(this.buildProperty(0x01, limit))));
    }
    ...
    value: function setChargeMode(chargeMode) {
      (0, _validate.validate)([{
        value: chargeMode,
        name: 'Charge mode',
        condition: _validate.Joi.string().valid('immediate', 'timer_based').required()
      }]);
