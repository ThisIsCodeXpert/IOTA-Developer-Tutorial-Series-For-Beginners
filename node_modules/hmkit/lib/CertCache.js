  ...
  _createClass(CertCache, [{
    ...
    value: function storePath() {
      if (process.env.HM_NODE_SDK_STORAGE_PATH) {
        return _path2.default.resolve(process.env.HM_NODE_SDK_STORAGE_PATH, CACHE_STORE_NAME) + '.json';
      }
      return _path2.default.resolve(__dirname, '..', 'storage', CACHE_STORE_NAME) + '.json';
    }
  }, {
    ...
    value: function get(filterFunction) {
      ...
      return new _AccessCertificate2.default((0, _encoding.base64ToUint8)(c));
    }
  }, {
    key: 'updateTimestamp',
    ...
    value: function getStore() {
      if (!_fs2.default.existsSync(this.storePath())) {
        return [];
      }

      var storeContents = _fs2.default.readFileSync(this.storePath(), 'utf8');
    ...
    value: function setStore(data) {
      _fs2.default.writeFileSync(this.storePath(), JSON.stringify(data, null, 2));
    }
  }, {
    key: 'setRawStore',
    value: function setRawStore(data) {
      _fs2.default.writeFileSync(this.storePath(), data);
    }
  }, {
    key: 'setCacheTTL',
    ...
    value: function destroy() {
      if (!_fs2.default.existsSync(this.storePath())) return;
      _fs2.default.unlinkSync(this.storePath());
    }
  }]);
