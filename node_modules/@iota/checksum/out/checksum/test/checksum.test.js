...
ava_1["default"]('addChecksum() adds 9-trytes checksum', function (t) {
    t.is(src_1.addChecksum(samples_1.addresses[0]), samples_1.addressesWithChecksum[0], 'addChecksum() should add 9-trytes checksum to the end of address.');
    t.deepEqual(src_1.addChecksum(samples_1.addresses.slice(0, 1)), samples_1.addressesWithChecksum.slice(0, 1), 'addChecksum() should add 9-trytes checksum to the end of each address in a given array.');
});
ava_1["default"]('addChecksum() returns the exact address, if was passed with checksum', function (t) {
    t.is(src_1.addChecksum(samples_1.addressesWithChecksum[0]), samples_1.addressesWithChecksum[0], 'addChecksum() should return the exact address, if was passed with checksum.');
});
...
ava_1["default"]('addChecksum() does not mutate the original array', function (t) {
    var arr = samples_1.addresses.slice(0, 1).map(function (a) { return a.slice(0, 81); }).slice();
    src_1.addChecksum(arr);
    t.deepEqual(arr, samples_1.addresses.slice(0, 1), 'addChecksum() should not mutate the original array.');
});
...
ava_1["default"]('isValidChecksum() correctly validates the checksum', function (t) {
    ...
    t.is(src_1.isValidChecksum(samples_1.addresses[0]), false, 'isValidChecksum() should return false for address without checksum.');
});
...
ava_1["default"]('removeChecksum() removes checksum from addresses with checksum', function (t) {
    t.deepEqual(src_1.removeChecksum(samples_1.addressesWithChecksum.slice(0, 1)), samples_1.addresses.slice(0, 1), 'removeChecksum() should remove checksum from address with checksum.');
    t.deepEqual(src_1.removeChecksum(samples_1.addressesWithChecksum.slice(0, 1)), samples_1.addresses.slice(0, 1), 'removeChecksum() should remove checksum from each address with checksum in given array.');
});
ava_1["default"]('removeChecksum() returns the exact address, if was passed without checksum', function (t) {
    t.deepEqual(src_1.removeChecksum(samples_1.addresses), samples_1.addresses, 'removeChecksum() should return the exact address if was passed without checksum.');
});
ava_1["default"]('removeChecksum() does not mutate the original array', function (t) {
    var arr = [samples_1.addressWithChecksum];
    src_1.removeChecksum(arr);
    t.deepEqual(arr, [samples_1.addressWithChecksum], 'removeChecksum() should not mutate the original array.');
});
