...
exports.batchedSendNock_1 = nock('http://localhost:24265', send_test_1.headers(API_VERSION))
    .persist()
    .post('/', exports.command_1)
    .reply(200, exports.response_1);
exports.batchedSendNock_2 = nock('http://localhost:24265', send_test_1.headers(API_VERSION))
    .persist()
    .post('/', exports.command_2)
    .reply(200, exports.response_2);
exports.batchedSendNock_3 = nock('http://localhost:24265', send_test_1.headers(API_VERSION))
    .persist()
    .post('/', exports.command_3)
    .reply(200, exports.response_3);
exports.batchedSendNock_4 = nock('http://localhost:24265', send_test_1.headers(API_VERSION))
    .persist()
    .post('/', exports.command_4)
    .reply(200, exports.response_4);
exports.batchedSendNock_5 = nock('http://localhost:24265', send_test_1.headers(API_VERSION))
    .persist()
    .post('/', exports.command_5)
    .reply(200, exports.response_5);
