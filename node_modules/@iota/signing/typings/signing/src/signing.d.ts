 ...
 */
export declare function digest(normalizedBundleFragment: Int8Array, signatureFragment: Int8Array): Int8Array;
/**
 ...
 */
export declare function signatureFragment(normalizedBundleFragment: Int8Array, keyFragment: Int8Array): Int8Array;
/**
 ...
 * @return {boolean}
 */
export declare function validateSignatures(expectedAddress: string, signatureFragments: ReadonlyArray<string>, bundleHash: string): boolean;
/**
 ...
 */
export declare const normalizedBundleHash: (bundleHash: string) => Int8Array;
