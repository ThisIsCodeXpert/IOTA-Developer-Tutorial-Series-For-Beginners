...
import { Address, Callback, Provider, Transaction, Transfer, Trytes } from '../../types';
 ...
 */
export declare const createPrepareTransfers: (provider?: Provider | undefined, now?: () => number, caller?: string | undefined) => (seed: string, transfers: ReadonlyArray<Transfer>, options?: Partial<PrepareTransfersOptions>, callback?: Callback<ReadonlyArray<string>> | undefined) => Promise<ReadonlyArray<string>>;
...
export declare const addSignatures: (props: PrepareTransfersProps) => PrepareTransfersProps;
